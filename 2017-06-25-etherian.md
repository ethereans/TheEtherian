...
- [Augur Weekly Development Update — June 21st](https://medium.com/@AugurProject/augur-weekly-development-update-june-21st-b3f19cca2317)
...
- Blog: [Security tips&tools for your ICONOMI account](https://medium.com/iconominet/security-tips-tools-for-your-account-2dae4017b1c5).
- ICONOMI now supports cofound it $CFI tokens.
...
- Blog: [Melon dev update June 2017](https://medium.com/melonport-blog/melon-dev-update-may-2017-450a05cc6be3).
- Meet up: [Zug](https://pbs.twimg.com/media/DDPVUA8XgAAsjuj.jpg).
- > Monaelisa: "0x are one of the companies w are working with them to see if its possible to integrate  protocol as exchange module > we will update on that officially when its ready and working."
- > Monaelisa: "We should have the new UI out soon, bare with us as we work to redeploy in the next couple of days."
...
- Round 2 of the new UI/UX art work has been presented and feedback givven.
- Work has begun cleaning up the tag lists
- Plans to outreach with other ethereum related sites and tools.
- Blog: [A second life for all of us](https://medium.com/ethercasts/a-second-life-for-all-of-us-ce56ee048dc4).

---
##### [Status](http://status.im/) – Mobile Ethereum OS
- [Instructions on Converting SGT into SNT](https://contribute.status.im/sgt.html)
- [Status Contribution Period: Recap](https://blog.status.im/status-contribution-period-recap-36e64d35d3e4)
---
